...
using P04WeatherForecastAPI.Client.Services.OrderServices;
...
namespace P04WeatherForecastAPI.Client
{
    ...
    public partial class App : Application
    {
        ...
        private void ConfigureHttpClients(IServiceCollection services, AppSettings appSettingsSection)
        {
            ...
            var uriBuilderO = new UriBuilder(appSettingsSection.BaseAPIUrl)
            {
                Path = appSettingsSection.BaseOrderEndpoint.Base_url,
            };
            //Microsoft.Extensions.Http
            services.AddHttpClient<IOrderService, OrderService>(client => client.BaseAddress = uriBuilderO.Uri);
        }
